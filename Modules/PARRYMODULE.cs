...
namespace ParryParryParryParryParryParryParryParryParryParryParry.Modules
{
    ...
    internal class PARRYMODULE : MonoBehaviour, IModule
    {
        ...
        static void Setup()
        {
            ...
            var setting = Settings.Add(global::ParryParryParryParryParryParryParryParryParryParryParry.ParryParryParryParryParryParryParryParryParryParryParry.Settings.wantActivated, "", "PARRRRTY TIME", "ACTIVATE THE PARRYNATOR", "", true);
